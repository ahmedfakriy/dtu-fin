      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-y-12 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            منصة تعليمية مستقلة تهدف إلى تسهيل حصول الطلاب على المحاضرات والملفات الدراسية،
من خلال تنظيم وتجميع المحتوى في مكان واحد لدعم تجربة التعلم بشكل أفضل.
تنويه: هذه المنصة لا تتبع المنصة الرسمية للجامعة، ولا تمثلها بأي شكل من الأشكال.
شكرًا لاستخدامكم منصتنا، ونتمنى لكم تجربة تعليمية ناجحة ومثمرة.
            <br />
