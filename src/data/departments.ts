        ...
        terms: [
          {
            ...
            nameAr: 'الترم الأول',
            subjects: [
              { id: 'mech-s2-t1-1', name: 'الديناميكا', nameAr: 'الديناميكا', driveLink: 'https://drive.google.com/drive/folders/3abc123' },
              { id: 'mech-s2-t1-2', name: 'الدوائر الكهربائية', nameAr: 'الدوائر الكهربائية', driveLink: 'https://drive.google.com/drive/folders/3def456' },
              { id: 'mech-s2-t1-3', name: 'المعادلات التفاضلية', nameAr: 'المعادلات التفاضلية', driveLink: 'https://drive.google.com/drive/folders/3ghi789' },
              { id: 'mech-s2-t1-4', name: 'التصميم الميكانيكي', nameAr: 'التصميم الميكانيكي', driveLink: 'https://drive.google.com/drive/folders/3jkl012' },
              { id: 'mech-s2-t1-5', name: 'الإلكترونيات التناظرية', nameAr: 'الإلكترونيات التناظرية', driveLink: 'https://drive.google.com/drive/folders/3mno345' },
        ...
        terms: [
          {
            ...
            nameAr: 'الترم الأول',
            subjects: [
              { id: 'mech-s3-t1-1', name: 'الروبوتيكا الأساسية', nameAr: 'الروبوتيكا الأساسية', driveLink: 'https://drive.google.com/drive/folders/5abc123' },
          ...
          },
          {
            ...
            nameAr: 'الترم الثاني',
            subjects: [
              { id: 'mech-s3-t2-1', name: 'الروبوتيكا المتقدمة', nameAr: 'الروبوتيكا المتقدمة', driveLink: 'https://drive.google.com/drive/folders/6abc123' },
              { id: 'mech-s3-t2-2', name: 'التحكم التكيفي', nameAr: 'التحكم التكيفي', driveLink: 'https://drive.google.com/drive/folders/6def456' },
              { id: 'mech-s3-t2-3', name: 'تعلم الآلة', nameAr: 'تعلم الآلة', driveLink: 'https://drive.google.com/drive/folders/6ghi789' },
              { id: 'mech-s3-t2-4', name: 'المحاكاة والنمذجة', nameAr: 'المحاكاة والنمذجة', driveLink: 'https://drive.google.com/drive/folders/6jkl012' },
              { id: 'mech-s3-t2-5', name: 'الشبكات الصناعية', nameAr: 'الشبكات الصناعية', driveLink: 'https://drive.google.com/drive/folders/6mno345' },
